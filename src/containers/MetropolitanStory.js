...
const MetropolitanStory = () => {
    ...
    const mainText =
        <React.Fragment>
            <div>
                <p><img src={window.location.origin + '/assets/images/features/metro/metro2-small.jpg'} className="feature-img" alt="Drawing of a Metropolitan"/>The Metropolitan was designed by William J. Flajole, for Nash Motor Division of Nash-Kelvinator Corporation in the United States. Built by Austin Motor Company of Birmingham, England, production began in October of 1953 and the first cars arrived in North America in December. The cars were built and marketed as Nash then, and later as Hudson Metropolitans as well, after the two companies merged as American Motors Corporation in 1954.</p>
