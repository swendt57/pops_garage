    ...
    const mainText =
        <React.Fragment>
            <div>
                ...
                <p>See a gallery of Bob Wagner's 1948 <a href={window.location.origin + '/assets/images/features/land_cruiser_gallery/index.html'}><strong>Studebaker Land Cruiser</strong></a> and read <a href="http://www.studebakermuseum.org/p/about/history/"><strong>The Studebaker Story</strong></a> on the official website of the Studebaker National Museum.</p>
