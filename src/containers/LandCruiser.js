    ...
    const mainText =
        <React.Fragment>
            <div>
                ...
                <p>What makes the car special? To me, it's a lot of little things: the "frontwards/backwards" styling with a one-piece windshield, 2-piece wraparound rear window, side vents in the front fenders, interior crank-up antenna, "hill holder" Overdrive, striped multicolored nylon upholstery, and nifty "come-together" front and back door handles. Many lookers also comment on the "rocket" hood ornament, which Studebaker showed off long before Oldsmobile ever thought of it. Being the premium model. It is a stretched body with spacious rear seating and lots of deco wood-grained and chrome appointments. This did not come cheap as it was priced right on with Buick Super or Chrysler. However. It was different and when do you see one today? </p>

                <p>Read <b><a href="http://www.studebakermuseum.org/p/about/history/">The Studebaker Story</a></b> on the official website of the Studebaker National Museum.</p>
