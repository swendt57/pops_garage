            ...
            <div className="container home">
                ...
                <div id="home-article-container">
                    <article>
                        ...
                        <div id="home-aside-container"><aside><img src={nash59} className="car-img" alt="Photo of a 1959 Nash station wagon"/>Remember when all the brands used the same front-ends and back-ends for all their models? Didn't matter if it was a four-door sedan, a two-door hard top, a convertible or a station wagon. You could tell what it was both coming and going! <br/><br/><strong>Coming soon</strong>, the Station Wagons of the post war independents!</aside></div>
                        ...
                        <p>In <Link to="/livery"><strong>The Library</strong></Link> you'll find car themed books that piqued Pop's interest. Everything from <strong>AMC Muscle Cars</strong> to <strong>Classic American Limousines</strong>. There's bound to be something for everyone here!</p>
                    </article>
                </div>
